...
const ContentLed = ({
  ...
  subtitle = 'Turn thought leadership into a pipeline. Bizwit Research enables B2C & B2B brands to create, distribute, and convert through research-driven content strategies.',
      ...
      <RootTag className="content-led">
        ...
        <div className="cl-container2">
          ...
          <div className="cl-media3">
            <p className="cl-title3">
              Content-led demand generation focuses on attracting, nurturing,
              and converting prospects using high-value content—such as
              whitepapers, infographics, and webinars—strategically aligned with
              buyer personas and journey stages. Content-led demand generation
              focuses on attracting, nurturing, and converting prospects using
              high-value content—such as whitepapers, infographics, and
              webinars—strategically aligned with buyer personas and journey
              stages.Content-led demand generation focuses on attracting,
              nurturing, and converting prospects using high-value content—such
              as whitepapers, infographics, and webinars—strategically aligned
              with buyer personas and journey stages.
            </p>
          </div>
        ...
        <div className="cl-container3">
          <div className="cl-media5">
            ...
            <p className="cl-title4">
              4.6 billion pieces of content are produced daily. And in this sea
              of information, merely standing out is not enough.
            </p>
          </div>
          <div className="cl-media6">
            <p className="cl-titl6">Why TLDG?</p>
            <p className="cl-subtitle">
              A recent survey conducted by MarketsandMarkets-about 15,000
              marketing leaders from Vps to CXOs who participated-suggests a
              staggering 83% of industry marketing leaders affirm the
              indispensable role of new economy positioning in augmenting B2B
              growth.
            </p>
          </div>
          ...
          <div className="cl-media7">
            ...
            <p className="cl-subtitle1">
              By leveraging events, webinars, whitepapers, and videos, we turn
              them into powerful tools for B2B demand generation, securing
              qualified leads and boosting your visibility and target market
              interaction.
            </p>
          </div>
          <div className="cl-media8">
            <p className="cl-title6">Overcoming Content Creation Challenges</p>
            <p className="cl-subtitle2">
              45% indicate the heightened difficulty of crafting distinctive,
              impactful content in the AI era, so adopting a meticulously
              crafted strategy is crucial for standing out.
            </p>
          </div>
        </div>
      </RootTag>
